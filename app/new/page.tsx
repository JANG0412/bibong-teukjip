    ...
    <div className="space-y-4">
      ...
      >
        <div className="grid grid-cols-1 gap-4">
          ...
          <label className="space-y-2">
            <div className="text-sm font-semibold text-zinc-800">사진 업로드</div>
            <input
              name="photos"
              type="file"
              accept="image/*"
              multiple
              className="block w-full text-sm file:mr-4 file:rounded-full file:border-0 file:bg-rose-100 file:px-4 file:py-2 file:text-sm file:font-semibold file:text-rose-700 hover:file:bg-rose-200"
            />
            <div className="text-xs text-zinc-500">
              이미지 파일만 저장돼요. (여러 장 가능)
            </div>
          </label>
